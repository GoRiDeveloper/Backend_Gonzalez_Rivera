...
export default function Cliente ({ cliente }) {
    ...
    [ eliminarCliente ] = useMutation(ELIMINAR_CLIENTE, {

        update(cache) {

            const 
            
            QUERY                       = cache.readQuery({ query: OBTENER_CLIENTES_USUARIO }),
    ...
    return (
        ...
        <tr>
            ...
            <td className="text-black text-center border px-4 py-2"> {nombre} {apellido} </td>
            <td className="text-black text-center border px-4 py-2"> {empresa} </td>
            <td className="text-black text-center border px-4 py-2"> {email} </td>
